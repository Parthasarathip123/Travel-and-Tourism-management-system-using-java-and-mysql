...
class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
       String[] text = new String[]{"Red Hotel", "Blue Hotel", "Marriott Hotel", "Miami Hotel", "Los Vegas Hotel", "New York Hotel", "Berlin Hotel", "Barcelona Hotel","austin hotel","madrid hotel"};
